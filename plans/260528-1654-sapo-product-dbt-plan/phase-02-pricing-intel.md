...
- [ ] Wait for Phase 1 `src_sapo_product_variants` to be created
- [ ] Create `transformation/models/staging/src_sapo_variant_prices.sql`
- [ ] Ensure `transformation/models/marts/products/` directory exists (Phase 4 may create it first)
- [ ] Create `transformation/models/marts/products/dim_price_lists.sql`
- [ ] Create `transformation/models/marts/products/fact_variant_prices_snapshot.sql`
- [ ] Add schema.yml tests
- [ ] Run: `dbt build --select +dim_price_lists +fact_variant_prices_snapshot`
- [ ] Verify: 17 rows in dim_price_lists; GIANHAP is_cost=true; BANLE is_default=true
- [ ] Verify: fact_variant_prices_snapshot has no zero-price rows
- [ ] Verify: implied_gross_margin_pct for VCST21004L001 BANLE ≈ (2425000 - 510840) / 2425000 ≈ 78.9%
