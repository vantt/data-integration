...
|-------|------|--------|----------|--------|
| [Phase 1: Foundational fix](phase-01-foundational-fix.md) | dim_products + dim_product_variants + seed_sku_alias | READY | P0 | Low |
| [Phase 2: Pricing intelligence](phase-02-pricing-intel.md) | dim_price_lists + fact_variant_prices_snapshot | READY | P2 | Medium |
| [Phase 3: Inventory views](phase-03-inventory-views.md) | fact_inventory_snapshot + mart_inventory_health | Needs daily snapshot | P3 | Medium |
| [Phase 4: Bundle/composite tracking](phase-04-bundle-components.md) | dim_bundle_components | READY | P4 | Low-Medium |
