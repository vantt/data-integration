...
**Registry:** [FIND-002](../REGISTRY.md#find-002)
...
> có thể cao hơn bảng 2.3. → sửa cửa-vào trước khi xây thêm reminder. [fresh-scan §B](./FIND-007-fresh-scan-data-market.md#b-đòn-bẩy-mới-lớn-nhất--sản-phẩm-cổng-vào-entry-sku--retention)
...
> **Việc build data** (model waterfall, dashboard Retention Health) → [04-opportunities/data-backlog](./../04-opportunities/OPP-004-data-backlog.md).
