...
## Todo
- [x] Verify Apr-2026 4-orders service_fee=0 (pre-req)
- [x] Parser: drop aggregate + add payment_fee aliases
- [x] Parser: schema-drift guard (alert on unmapped Phí/Thuế columns) + optional payout reconciliation checksum
- [x] stg/int/fact_order_costs edits + fact_order_economics comment
- [x] Re-ingest all archived Shopee files
- [x] Guard test `assert_shopee_no_platform_service_double_count`
- [x] Dagster run green + Metabase verify
