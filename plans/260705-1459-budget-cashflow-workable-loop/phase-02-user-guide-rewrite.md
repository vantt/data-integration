# Phase 02 — Viết lại User Guide khớp sheet thật (P0)
...
`docs/analytics-handbook/guides/finance-budget-user-guide.md` hiện mô tả sheet long-format + quy trình "download CSV → save đè seed" — sai với sheet matrix thật, làm theo sẽ fail. Viết lại toàn bộ §2 (Duy trì budget) + FAQ liên quan theo quy trình mới của phase-01.

## Phụ thuộc

Phase-01 xong (quy trình mới mới chốt được). Có thể draft song song, publish sau khi phase-01 E2E pass.
...
| §4 Lịch vận hành | Khớp với lịch re-pull mới (phase-04): sổ MISA chốt ~ngày 10 → review variance sau ngày 10 | Cập nhật bảng lịch |
