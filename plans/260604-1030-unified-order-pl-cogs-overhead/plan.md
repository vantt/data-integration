...
- Overhead-session questions still open (overhead doc §"Câu hỏi còn mở"): MISA API vs export, pool scope, base choice, realtime-vs-closure — resolve before phase 04.
