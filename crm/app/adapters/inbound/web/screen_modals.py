...
from crm.app.domain.entities.app_user import AppUser
from crm.app.domain.entities.party import Party
from crm.app.domain.entities.profile import CustomerProfile, Party360
...
async def post_create_party(
    ...
    from crm.app.domain.entities.profile import PartyIdentity  # local import avoids circular
