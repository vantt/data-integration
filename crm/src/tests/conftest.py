"""conftest.py — shared pytest fixtures for crm/src/tests/.

sys.path setup:
  - repo root (data-integration/) for crm.src.* namespace
  - crm/src/ for bare domain.* / application.* imports used inside app modules
