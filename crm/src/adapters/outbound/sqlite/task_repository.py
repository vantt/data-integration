...
INSERT INTO crm_task (
  ...
  task_kind, channel, value_at_stake_vnd, top_affinity_product, claimed_action_types
) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
"""
...
SELECT
  ...
  t.task_kind, t.channel, t.value_at_stake_vnd, t.top_affinity_product, t.claimed_action_types,
...
def _task_from_row(row: sqlite3.Row) -> Task:
    ...
    return Task(
        ...
        # Migration 0043: None for pre-migration rows and non-claim task sources.
        claimed_action_types=row["claimed_action_types"] if "claimed_action_types" in keys else None,
