...
from adapters.inbound.web.screen_mgmt_campaigns import make_campaigns_router
from adapters.inbound.web.screen_mgmt_dedup import make_dedup_router
from adapters.inbound.web.screen_mgmt_segments import make_segments_router
from adapters.inbound.web.screen_mgmt_settings import make_settings_router
