...
class ProfileSvc(Protocol):
    ...
    def attach_tag(
        self, party_id: str, tag_id: str, user_id: Optional[str] = None,
        source: str = "crm_user", source_activity_id: Optional[str] = None,
    ) -> None: ...
    def detach_tag(self, party_id: str, tag_id: str) -> None: ...
    def get_tag(self, tag_id: str) -> Optional[Tag]: ...
    def find_or_create_tag(
        self, name: str, category: Optional[str], is_provisional: bool = True,
        color: str = "default", display_label: str = "",
    ) -> Tag: ...
