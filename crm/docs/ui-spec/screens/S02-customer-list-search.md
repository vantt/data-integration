...
content:
  ...
  result_list:
    - row:
        - { h: "Kết quả (128)" }
        - { btn: "＋ Tạo mới", action: A-S02-002, primary: true }
    - table: { cols: ["Họ tên", "SĐT", "Group", "Status", "Owner", "Mua gần nhất"], rows: 5 }
    - row:
        - { text: "Trang 1/10" }
        - { btn: "‹ Trước", action: A-S02-008 }
        - { btn: "Sau ›", action: A-S02-007 }
```
