...
|---|-----|------|------|----------|-------|------|---------------|------------|
| 1 | A | "Ket qua tuan (Mon–Sun)" | annotation | text-annotation | structural | full-width x minimal | Section heading — subtitle: "Sales Ops — Tuan qua van hanh co on khong?" | — |
...
| 6 | C | "Trang thai don hang" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 10 | E | "Xu huong don hang (14 ngay)" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| # | Row | Card | Role | Viz Type | Color | Size | Communication | Comparison |
|---|-----|------|------|----------|-------|------|---------------|------------|
| 13 | A | "Phan bo don hang theo kenh" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 16 | C | "Hieu suat kenh so voi tuan truoc" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 18 | E | "Phan bo theo chi nhanh" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| # | Row | Card | Role | Viz Type | Color | Size | Communication | Comparison |
|---|-----|------|------|----------|-------|------|---------------|------------|
| 21 | A | "Social Commerce (Facebook + Zalo)" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 25 | C | "Hieu suat nhan vien" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 28 | E | "Thanh toan & Doi soat" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
