...
|---|-----|------|------|----------|-------|------|---------------|------------|
| 1 | A | "Hieu suat Kenh tuan (Mon-Sun)" | annotation | text-annotation | structural | full-width x minimal | Section heading — subtitle: "Marketing — Kenh nao hieu qua nhat tuan nay?" | — |
...
| 6 | C | "Xu huong Ecommerce vs Offline (14 ngay)" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 9 | E | "Phan bo doanh thu theo Platform" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 12 | G | "Chi tiet Kenh — so voi tuan truoc" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| # | Row | Card | Role | Viz Type | Color | Size | Communication | Comparison |
|---|-----|------|------|----------|-------|------|---------------|------------|
| 14 | A | "Khach hang tuan nay" | annotation | text-annotation | structural | full-width x minimal | Section heading — subtitle: "Tuan nay co bao nhieu khach moi va tu dau?" | — |
...
| 19 | C | "Kenh nao mang khach moi nhieu nhat?" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 22 | E | "Xu huong Acquisition (14 ngay)" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| # | Row | Card | Role | Viz Type | Color | Size | Communication | Comparison |
|---|-----|------|------|----------|-------|------|---------------|------------|
| 25 | A | "Promotion & Discount" | annotation | text-annotation | structural | full-width x minimal | Section heading — subtitle: "Discount co dang kiem soat? Promotion nao hieu qua?" | — |
...
| 30 | C | "Promotion dang chay" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
...
| 33 | E | "Social Commerce (Facebook + Zalo)" | annotation | text-annotation | structural | full-width x minimal | Section heading | — |
