...
## ⚠️ Quan Trọng: Giá Bán Sapo Đã Gồm VAT (VAT-Inclusive Pricing)

**Giá bán trong Sapo ĐÃ gồm VAT.** Xác nhận từ dữ liệu thực tế: tỷ lệ tax/net = 8/108 và 10/110 chứng minh VAT nhúng trong giá bán (fix 2026-06-03).
...
> Xem đầy đủ: [Revenue Terminology](../analytics-handbook/guides/revenue_terminology.md)
