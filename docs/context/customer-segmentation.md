...
- **customer_type vs value_group** — customer_type là bản chất quan hệ (RETAIL, WHOLESALE, CROSSBORDER); value_group là giá trị đóng góp (VALUE_VIP, VALUE_GOLD)
...
| Partner     | `PARTNER`     | CTV, đại lý nhỏ, đối tác, **ký gửi**                                               | Giá đối tác (theo thỏa thuận)        |
| Staff       | `STAFF`       | Nhân viên công ty                                                                               | Giá ưu đãi nhân viên                 |
| KOL         | `KOL`         | Influencer, người có ảnh hưởng                                                               | Giá ưu đãi + hỗ trợ content          |
| CrossBorder | `CROSSBORDER` | Đơn US giao hàng hộ — người nhận ở VN (đơn US bị loại khỏi doanh thu ở tầng kênh) | N/A — ngoài scope doanh thu              |
...
| ------------------------------------- | -------- | -------------------------------------------------------- | ---- |
| Bán lẻ (BANLE) + TYPE_RETAIL        | —       | RETAIL                                                   | 6573 |
| Selly (CTN00013)                      | —       | **RETAIL** (khách cuối, tái tiếp thị được) | 104  |
| Bán buôn (BANBUON) + TYPE_WHOLESALE | —       | WHOLESALE                                                | 161  |
| Ký Gửi (KY_GUI)                     | —       | **PARTNER**                                        | 11   |
| US (CTN00014)                         | —       | **CROSSBORDER**                                    | 662  |
| VIP/Unknown/untagged                  | —       | RETAIL                                                   | ~2   |

### Bước 2: Tạo thêm customer_type (Manual)

| Group Name  | Code               | Note                                           |
| ----------- | ------------------ | ---------------------------------------------- |
| Partner     | PARTNER            | CTV, đại lý nhỏ, ký gửi                  |
| Staff       | STAFF              | Nhân viên                                    |
| KOL         | KOL                | Influencer, người có ảnh hưởng           |
| CrossBorder | CROSSBORDER (MỚI) | Đơn US giao hàng hộ — người nhận ở VN |
...
- [ ] Chuẩn hóa RETAIL, WHOLESALE, CROSSBORDER trong Sapo
- [ ] Tạo PARTNER, STAFF, KOL, CROSSBORDER groups
