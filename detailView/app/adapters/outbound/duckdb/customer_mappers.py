...
def map_profile(row: Row) -> CustomerProfile:
    return CustomerProfile(
        ...
        birth_date=rc.as_date(row.get("birth_date")),  # birth_date is VARCHAR in dim_customers
        gender=rc.as_str(row.get("gender")),
        ...
        loyalty_points=rc.as_int(row.get("loyalty_points")),
